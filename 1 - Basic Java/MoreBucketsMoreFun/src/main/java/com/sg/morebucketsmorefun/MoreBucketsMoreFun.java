...
public class MoreBucketsMoreFun {
    public static void main(String[] args){
        ...
        butterflies--; // -- operator for subtration by one
        System.out.println("Now there are only " + butterflies + " butterflies left.");
        System.out.println("But still " + bugs + " bugs left, wait a minute!!!");
        System.out.println("Maybe I just conted wrong the first time...");
        
        // The number of bugs does not change, because it's a different variable.
